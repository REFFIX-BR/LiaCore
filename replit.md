...
- **Suporte AI Anti-Hallucination Fix v1.1.2-1.1.3** (Dec 6, 2025): CORRIGIDO - IA ALUCINANDO ao prometer ações sem executar. Renata (5524992950208) recebeu "atendente foi acionado" SEM transferência real. Queli Cristina (5524992002134) disse "estou com dificuldade para consultar" SEM chamar API. Nova REGRA ANTI-ALUCINAÇÃO proíbe: (1) Dizer que acionou/transferiu SEM chamar `rotear_para_assistente()`, (2) Oferecer "reinicia modem" como plano B quando API falha, (3) Usar desculpas tipo "estou com dificuldade" - DEVE chamar função ou TRANSFERIR. Sincronizado com OpenAI Assistants API v1.1.3.
